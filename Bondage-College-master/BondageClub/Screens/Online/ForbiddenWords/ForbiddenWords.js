 ...
 */
async function ForbiddenWordsLoad() {
...
function ForbiddenWordsExit() {
	...
	if (C) {
		ServerSend("ChatRoomChat", { Content: "OwnerRuleForbiddenWords" + FW, Type: "Hidden", Target: C.MemberNumber });
