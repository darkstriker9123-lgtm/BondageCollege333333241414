 ...
 */
function CellClick() {
	if (MouseIn(1885, 25, 90, 90) && Player.CanKneel() && (CellOpenTimer > CurrentTime)) PoseSetActive(Player, (Player.ActivePoseMapping.BodyLower !== "Kneel") ? "Kneel" : "BaseLower", true);
