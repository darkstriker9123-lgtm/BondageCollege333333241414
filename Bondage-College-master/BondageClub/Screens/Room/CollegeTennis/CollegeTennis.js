 ...
 */
function CollegeTennisCanInviteToPrivateRoom() { return PrivateHasEmptySlot(); }
 ...
 */
async function CollegeTennisLoad() {
	...
	if (CollegeTennisJennifer == null) {
		...
		if (CollegeTennisJenniferStatus != "Away") {
			...
			InventoryWear(CollegeTennisJennifer, "Small", "HandsLeft", "Default");
			InventoryWear(CollegeTennisJennifer, "Small", "HandsRight", "Default");
...
function CollegeTennisGameEnd() {
	...
	CollegeTennisJenniferWillJoinRoom = ((CollegeTennisJennifer.Name == "Jennifer") && MiniGameVictory && (MiniGameDifficultyMode != "Easy") && (CollegeTennisJenniferStatus != "Lover") && (CollegeTennisJenniferStatus != "Owned") && (CollegeTennisJenniferStatus != "Curfew") && (CollegeTennisJenniferStatus != "Owner") && LogQuery("RentRoom", "PrivateRoom") && PrivateHasEmptySlot());
}
...
function CollegeTennisInviteToPrivateRoom() {
	...
	const C = PrivateAddCharacter(CollegeTennisJennifer, null, true);
	...
	C.Love = 20;
	if (CollegeTennisJennifer.IsOwnedByCharacter(Player)) {
	...
	if (Player.IsOwnedByCharacter(CollegeTennisJennifer)) {
